...
class AlexNet(object):
  ...
  def create(self):
    ...
    self.fc10 = fc(dropout9, 1000, 2, name = 'fc10', relu = False)  #output is 2 since I don't do sigmoid here
    self.fc10 = flip_grad(self.fc10) # Use for idea that if using negative domain loss, flipping takes place inversly (and twice)
