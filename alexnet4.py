...
class AlexNet(object):
  ...
  def __init__(self, x, keep_prob, num_classes, skip_layer, batch_size,
  ...
  def create(self):
    ...
    #Adding domain classifier    
    #grl = self.flip_gradient(dropout6)
    grl = flip_grad(dropout6)
    fc9 = fc(grl, 4096, 1000, name = 'fc9')
    #dropout9 = dropout(fc9, self.KEEP_PROB)
    self.fc10 = fc(fc9, 1000, 2, name = 'fc10', relu = False)  #output is 2 since I don't do sigmoid here
    
    fc9_1 = fc(dropout6,4096,1000,name = 'fc9_1')
    #dropout9_1 = dropout(fc9_1, self.KEEP_PROB)
    self.fc10_1 = fc(fc9_1, 1000, 2, name = 'fc10_1', relu = False)
    
    #Adding class classifier
    #select_feat = tf.slice(dropout6, [0, 0], [self.batch_size//2, -1])

    # 7th Layer: FC (w ReLu) -> Dropout
    #fc7 = fc(select_feat, 4096, 4096, name = 'fc7')
